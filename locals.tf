...
locals {
  ...
  notifications_slack = try(var.notifications.slack.webhook_url, null) != null ? {
  ...
  notifications_teams = try(var.notifications.teams.webhook_url, null) != null ? {
  ...
  notifications_email = try(var.notifications.email.addresses, null) != null ? {
